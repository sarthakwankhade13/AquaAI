...
export default function Profile() {
  const [profile, setProfile] = useState({
    fullName:     'WRD Super Admin',
    email:        'admin@wrd.maharashtra.gov.in',
    mobile:       '9876543210',
    designation:  'Water Resource Department — Super Administrator',
  ...
  const InputRow = ({ label, value, onChange, type = 'text' }) => (
    <div style={{ display:'flex', flexDirection:'column', gap:5 }}>
      ...
      <input
        ...
        style={{ height:40, padding:'0 12px', border:'1.5px solid #e2e8f0', borderRadius:8, fontSize:13, color:'#334155', outline:'none', background:'#f8fafc' }}
      />
    </div>
  );
      ...
      <div className="adm-page">
        <div className="adm-page-header">
          <div>
            ...
            <div className="adm-page-desc">Manage your account information and security settings</div>
          </div>
        </div>
        ...
        <div className="adm-card">
          ...
          <div className="adm-card-pad" style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:16 }}>
            ...
            <InputRow label="Email Address"   value={profile.email}        onChange={(v) => handle('email', v)} type="email" />
            ...
            <InputRow label="Organization"    value={profile.organization} onChange={(v) => handle('organization', v)} />
